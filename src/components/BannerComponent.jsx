        ...
        >
          ...
          >
            ...
            <div className="carousel-inner">
              {ads.map((ads, index) => {
                if (index === 0) {
                   return <div key={index} className="carousel-item active" data-bs-interval="3500">
                    <img className="sid-img-carousel" src={ads.imgUri} alt="..." />
                  </div>;
                } else {
                  return <div key={index}  className="carousel-item" data-bs-interval="3500">
                    <img className="sid-img-carousel" src={ads.imgUri} alt="..." />
                  </div>;
                }
              })}
